...
chessboard_size = (8, 6)	# width, height
...
np.savez(
    "params/stereo_params_undistort.npz", K1=K1, D1=D1, K2=K2, D2=D2, R=R, T=T, map1_l=map1_l, map2_l=map2_l, map1_r=map1_r, map2_r=map2_r
)
