...
while photo_counter != total_photos:
    ...
    leftName = 'img/captures_alt/left_' + str(photo_counter).zfill(2) + '.png'
    rightName = 'img/captures_alt/right_' + str(photo_counter).zfill(2) + '.png'
    #leftName =  'img/captures/left_' + str(photo_counter) + '.png'
    #rightName = 'img/captures/right_' + str(photo_counter) + '.png'
    print('Importing pair ' + str(photo_counter) + ' : ' + leftName + ' | ' + rightName)
...
calibration.export('params')
print('Calibration complete!')

# Lets rectify and show last pair after  calibration
calibration = StereoCalibration(input_folder='params')
...
cv2.imwrite("img/captures_alt/rectified_left.jpg", rectified_pair[0])
cv2.imwrite("img/captures_alt/rectified_right.jpg", rectified_pair[1])
cv2.waitKey(0)
