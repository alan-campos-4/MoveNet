...
"""
Meassures the framerate of one camera feed with no additional operations.
"""
...
if __name__ == '__main__':
	...
	# Saves the results
	with open("output/timestamps/test_simple.txt", "w") as f:
		f.write(f"Display one camera during {MAX_SECONDS}.\n")
		for fps in fps_rec:
			f.write(f'FPS: {fps}')
			f.write('\n')
